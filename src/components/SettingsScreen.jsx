/* ═══════════════════════════════════════════════════════════════════
   ...
   Écran paramètres avec :
     ...
     - Langue (FR / EN, option conservée pour la roadmap V2)
     - Thème (sombre / clair)
...
function SettingsScreen({ settings, onChange, onClose, onReset }) {
  ...
  const tr = (key, params) => window.STI18n ? window.STI18n.t(key, params, s.lang) : key;
  const languages = window.STI18n ? window.STI18n.languages : [
  ...
  return (
    <div style={SS.root}>
      ...
      <div style={SS.content}>
        {/* Audio & haptics */}
        <Section title={tr("audioVibration")}>
          <Row
            label={tr("soundFx")}
            description={tr("soundFxDesc")}
            control={
        ...
        <Section title={tr("about")}>
          <Row label={tr("version")} value="1.22.10" />
